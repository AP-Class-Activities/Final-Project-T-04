...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_13.clicked.connect(self.gotowin77)
...
"background-color: rgb(170, 255, 127);")
        ...
        self.label_4.setPixmap(QtGui.QPixmap("IMG_2916.JPG"))
    ...
    def gotowin77(self):                             #vasl b sabadkharid dialog
        self.mw75 = QtWidgets.QMainWindow()
        self.win77 = boxmessage.Ui_MainWindow()
        self.win77.setupUi(self.mw75)         
