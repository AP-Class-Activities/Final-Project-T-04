...
"}")
    ...
    def gotowin7(self):                             #back b welcome
        self.mw5 = QtWidgets.QMainWindow()
        self.win7 = welcome.Ui_MainWindowwelcome()
        self.win7.setupUi(self.mw5)
