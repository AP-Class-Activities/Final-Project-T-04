...
# Form implementation generated from reading ui file 'carpet.ui'
#
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Downloads/IMG_2972.PNG"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
