...
"")
        ...
        self.label_4.setPixmap(QtGui.QPixmap("IMG_2910.WEBP"))
...
"background-color: rgb(170, 255, 127);")
        ...
        self.pushButton_13.clicked.connect(self.gotowin75)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_9.clicked.connect(self.gotowin60)

    def gotowin60(self):                             #vasl b carpet
        self.mw58 = QtWidgets.QMainWindow()
        self.win60 = carpet.Ui_MainWindowcarpet()
        self.win60.setupUi(self.mw58)
        self.MainWindow.hide()
        self.mw58.show()            

    def gotowin75(self):                             #vasl b sabadkharid dialog
        self.mw73 = QtWidgets.QMainWindow()
        self.win75 = boxmessage.Ui_MainWindow()
        self.win75.setupUi(self.mw73)
