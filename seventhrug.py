...
"")
        ...
        self.label_4.setPixmap(QtGui.QPixmap("IMG_2904.JPG"))
...
"background-color: rgb(170, 255, 127);")
    ...
    def gotowin80(self):                     
        ...
        ID = self.ID()
        dict["cart"].append(ID)
        login_db.DataBase().add(dict)                    #vasl b favoritmessage dialog
    ...
    def gotowin62(self):                             #vasl b rug
        self.mw60 = QtWidgets.QMainWindow()
        self.win62 = rug.Ui_MainWindowrug()
