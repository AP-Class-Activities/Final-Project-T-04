...
"")
        ...
        self.label_4.setPixmap(QtGui.QPixmap("IMG_2914.JPG"))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_9.clicked.connect(self.gotowin63)

    def gotowin63(self):                             #vasl b carpet
        self.mw61 = QtWidgets.QMainWindow()
        self.win63 = carpet.Ui_MainWindowcarpet()
        self.win63.setupUi(self.mw61)
