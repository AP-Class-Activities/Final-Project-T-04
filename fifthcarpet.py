...
"")
        ...
        self.label_4.setPixmap(QtGui.QPixmap("IMG_2920.JPG"))
...
"background-color: rgb(170, 255, 127);")
        ...
        self.pushButton_13.clicked.connect(self.gotowin72)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_9.clicked.connect(self.gotowin61)

    def gotowin61(self):                             #vasl b carpet
        self.mw59 = QtWidgets.QMainWindow()
        self.win61 = carpet.Ui_MainWindowcarpet()
        self.win61.setupUi(self.mw59)
        self.MainWindow.hide()
        self.mw59.show()            
     
    def gotowin72(self):                             #vasl b sabadkharid dialog
        self.mw70 = QtWidgets.QMainWindow()
        self.win72 = boxmessage.Ui_MainWindow()
        self.win72.setupUi(self.mw70)
        self.mw70.show()           
