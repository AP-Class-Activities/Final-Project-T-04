...
"}")
    ...
    def gotowin26(self):                             #vasl b shop
        self.mw24 = QtWidgets.QMainWindow()
        self.win26 = shop.Ui_MainWindowshop()
