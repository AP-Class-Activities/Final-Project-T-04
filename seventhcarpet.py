...
"background-color: rgb(170, 255, 127);")
        ...
        self.pushButton_13.clicked.connect(self.gotowin74)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_9.clicked.connect(self.gotowin65)

    def gotowin65(self):                             #vasl b carpet
        self.mw63 = QtWidgets.QMainWindow()
        self.win65 = carpet.Ui_MainWindowcarpet()
        self.win65.setupUi(self.mw63)
        self.MainWindow.hide()
        self.mw63.show()                     

    def gotowin74(self):                             #vasl b sabadkharid dialog
        self.mw72 = QtWidgets.QMainWindow()
        self.win74 = boxmessage.Ui_MainWindow()
        self.win74.setupUi(self.mw72)
        self.mw72.show()                    
